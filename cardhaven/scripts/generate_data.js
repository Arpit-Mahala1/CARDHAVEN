...
const cards = [
  ...
  },
  {
    ...
    cardType: "defense",
    rarity: "uncommon",
    effect: { block: 10 }, // Approximation as dynamic values need engine support
  ...
  },
  {
    ...
    rarity: "uncommon",
    targetType: "all",
    effect: { damage: 2, hits: 1 }, // Dynamic based on status effects
  ...
  },
  {
    ...
    cardType: "attack",
    rarity: "legendary",
    effect: { damage: 999 }, // Simplified instant kill
...
const enemies = [
  ...
  },
  {
    ...
    actions: [
      ...
      { id: "a3", name: "Bat Swarm", damage: 5, hits: 3 } // Needs engine support for hits on enemies
    ],
...
const newEnemies = [...existingEnemies, ...enemies];
fs.writeFileSync('./src/data/enemies.json', JSON.stringify({ enemies: newEnemies }, null, 2));

console.log("Appended new cards and enemies.");
